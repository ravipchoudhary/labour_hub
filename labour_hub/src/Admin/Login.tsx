    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-[#c7e7ff] via-[#ffd6a5] to-[#ffb4c6] flex items-center justify-center px-4">
      ...
      >
        ...
        <div
          className="
            hidden md:block
            absolute left-0 top-0 h-full w-[55%]
            bg-[#fb923c] rounded-r-[180px]
          "
        ></div>
        ...
        >
          ...
          <form onSubmit={handleLogin}>
            <button
              type="submit"
              className="
                w-full bg-[#fb923c] text-white py-3 rounded-lg
                font-semibold hover:font-bold transition
              "
            >
              Login
            </button>
          ...
          <div className="flex justify-center gap-4 mt-4">
            {["G", "f", "Ø", "in"].map((icon, i) => (
              <div
                key={i}
                className="
                  w-10 h-10 text-black font-bold
